    ...
    <div className="overflow-y-auto overflow-x-hidden max-h-[75vh] pr-2 py-4">
            ...
            {topFiles.map(file => (
              ...
              {(() => {
                ...
                <button onClick={() => setActive(file)} title={file.originalName} className="text-sm text-[#1D2F58] font-semibold block truncate text-left cursor-pointer max-w-[10rem]">{file.originalName}</button>
